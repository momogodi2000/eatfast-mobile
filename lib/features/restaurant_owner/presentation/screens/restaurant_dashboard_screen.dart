                  ...
                  child: ListView(
                    ...
                    children: [
                      ListTile(
                        ...
                        title: const Text('Commande téléphonique'),
                        subtitle: const Text('Créer une commande pour un client'),
                        onTap: () {
                      ...
                      ListTile(
                        ...
                        subtitle: const Text('Commande à récupérer par le client'),
                        onTap: () {
                          Navigator.pop(context);
