...
abstract class RestaurantOwnerRepository {
  ...
  Future<Result<MenuCategory, String>> createMenuCategory(String restaurantId, MenuCategory category);
  ...
  // Analytics
  Future<Result<List<MenuItemPerformance>, String>> getItemPerformance(String restaurantId);
