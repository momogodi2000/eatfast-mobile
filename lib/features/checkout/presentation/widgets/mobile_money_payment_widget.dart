                ...
                validator: (value) {
                  ...
                  if (_selectedMethod == PaymentMethod.mtn) {
                    if (!value.startsWith('67') && !value.startsWith('65') &&
                        !value.startsWith('68')) {
                      return 'Numéro MTN invalide (doit commencer par 67, 65 ou 68)';
                    }
                  } else if (_selectedMethod == PaymentMethod.orange) {
                    if (!value.startsWith('69') && !value.startsWith('65')) {
                      return 'Numéro Orange invalide (doit commencer par 69 ou 65)';
                    }
                  }
                  return null;
                },
  ...
  String _getInstructionText() {
    switch (_selectedMethod) {
      case PaymentMethod.mtn:
        return 'Vous recevrez une notification sur votre téléphone MTN MoMo. Composez *126# pour confirmer le paiement.';
      case PaymentMethod.orange:
        return 'Vous recevrez une notification sur votre téléphone Orange Money. Composez #150# pour confirmer le paiement.';
      default:
