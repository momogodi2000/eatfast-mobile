...
abstract class AnalyticsRepository {
  ...
  Future<Result<AnalyticsDashboard, String>> getDashboard(String userId, DashboardType type);
  Future<Result<List<AnalyticsDashboard>, String>> getUserDashboards(String userId);
  ...
  Future<Result<void, String>> updateDashboard(String dashboardId, Map<String, dynamic> updates);
  ...
  // KPI Metrics
  Future<Result<List<KPIMetric>, String>> getKPIMetrics(String userId, DashboardType type);
  Future<Result<KPIMetric, String>> getKPIMetric(String metricId);
  Future<Result<void, String>> setKPITarget(String metricId, double targetValue);
  Future<Result<List<KPIMetric>, String>> getCustomKPIs(String userId);
  
  // Performance Insights
  Future<Result<PerformanceInsights, String>> getPerformanceInsights(String userId, DashboardType type);
  ...
  Future<Result<void, String>> updateAlert(String alertId, Map<String, dynamic> updates);
  Future<Result<void, String>> resolveAlert(String alertId);
  Future<Result<void, String>> deleteAlert(String alertId);
  
  // Real-time Metrics
  Future<Result<RealtimeMetrics, String>> getRealtimeMetrics(String userId, DashboardType type);
  Stream<RealtimeMetrics> watchRealtimeMetrics(String userId, DashboardType type);
  ...
  Future<Result<String, String>> generateReport(String reportId); // Returns download URL
  Future<Result<void, String>> scheduleReport(String reportId, ReportSchedule schedule);
  ...
  Future<Result<Map<String, dynamic>, String>> getAnalyticsSettings(String userId);
  ...
  Future<Result<Map<String, dynamic>, String>> getAPIPerformance(DateRange dateRange);
