...
class AdvancedAnalyticsService {
  ...
  Future<SpendingAnalytics> getSpendingAnalytics({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get spending analytics: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<OrderAnalytics> getOrderAnalytics({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get order analytics: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<RestaurantPreferences> getRestaurantPreferences({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get restaurant preferences: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<FoodCategoryAnalytics> getFoodCategoryAnalytics({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get category analytics: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<DeliveryAnalytics> getDeliveryAnalytics({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get delivery analytics: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<LoyaltyAnalytics> getLoyaltyAnalytics({
    String period = '12m',
  }) async {
    try {
      final response = await _apiClient.get(
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get loyalty analytics: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<SavingsAnalytics> getSavingsAnalytics({
    String period = '12m',
  }) async {
    try {
      final response = await _apiClient.get(
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get savings analytics: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<BehavioralAnalytics> getBehavioralAnalytics({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get behavioral analytics: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<ComparativeAnalytics> getComparativeAnalytics({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get comparative analytics: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<RealTimeAnalytics> getRealTimeAnalytics() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get real-time analytics: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<PredictiveAnalytics> getPredictiveAnalytics({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get predictive analytics: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<EnvironmentalImpact> getEnvironmentalImpact({
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get environmental impact: ${response.statusCode}');
      }
    } catch (e) {
  ...
  Future<AnalyticsSummary> getAnalyticsSummary() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        throw Exception('Failed to get analytics summary: ${response.statusCode}');
      }
    } catch (e) {
