...
class _AdvancedAnalyticsScreenState extends ConsumerState<AdvancedAnalyticsScreen>
  ...
  Widget build(BuildContext context) {
    final analyticsAsync = ref.watch(analyticsProvider(AnalyticsRequest(
          ...
          children: [
            _buildKPIGrid([
              KPIData(
                ...
                value: analytics.customerMetrics?.totalOrders?.toString() ?? '0',
              ...
              KPIData(
                ...
                value: '${analytics.customerMetrics?.totalSpent?.toStringAsFixed(0) ?? '0'} XAF',
              ...
              KPIData(
                ...
                value: '${analytics.customerMetrics?.averageOrderValue?.toStringAsFixed(0) ?? '0'} XAF',
              ...
              KPIData(
                ...
                value: analytics.customerMetrics?.loyaltyPoints?.toString() ?? '0',
                icon: Icons.star,
                color: Colors.purple,
              ),
            ]),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          OrderTrendsChart(
            trendData: analytics.orderTrends,
          ),
          const SizedBox(height: 24),
        ...
        child: Column(
          ...
          children: [
            _buildKPIGrid([
              KPIData(
                title: 'Revenus',
                value: '${analytics.restaurantMetrics?.totalRevenue?.toStringAsFixed(0) ?? '0'} XAF',
              ...
              KPIData(
                title: 'Commandes',
                value: analytics.restaurantMetrics?.totalOrders.toString() ?? '0',
                icon: Icons.receipt,
                color: Colors.blue,
              ...
              KPIData(
                title: 'Note moyenne',
                value: analytics.restaurantMetrics?.averageRating?.toStringAsFixed(1) ?? '0.0',
                icon: Icons.star,
                color: Colors.orange,
              ...
              KPIData(
                ...
                value: analytics.restaurantMetrics?.uniqueCustomers.toString() ?? '0',
                icon: Icons.people,
                color: Colors.purple,
            ...
            PerformanceMetricsWidget(
              metrics: analytics.driverMetrics ?? PerformanceMetrics(
      ...
      child: Column(
        ...
        children: [
          ...
          CustomerInsightsWidget(
            insights: analytics.customerInsights,
          ),
          const SizedBox(height: 24),
        ...
        child: Column(
          ...
          children: [
            _buildKPIGrid([
              KPIData(
                title: 'Livraisons',
                value: analytics.driverMetrics?.totalDeliveries.toString() ?? '0',
              ...
              KPIData(
                title: 'Revenus',
                value: '${analytics.driverMetrics?.totalEarnings?.toStringAsFixed(0) ?? '0'} XAF',
                icon: Icons.attach_money,
                color: Colors.green,
              ...
              KPIData(
                title: 'Note moyenne',
                value: analytics.driverMetrics?.avgRating?.toStringAsFixed(1) ?? '0.0',
                icon: Icons.star,
                color: Colors.orange,
                trend: null,
              ),
              KPIData(
                title: 'Temps actif',
                value: '${analytics.driverMetrics?.activeHours?.toStringAsFixed(1) ?? '0.0'}h',
          ...
          children: [
            _buildKPIGrid([
              KPIData(
                ...
                value: '${analytics.adminMetrics?.totalRevenue?.toStringAsFixed(0) ?? '0'} XAF',
                icon: Icons.monetization_on,
                color: Colors.green,
  ...
  Widget _buildMenuOptimizationSuggestions(AnalyticsData analytics) => Container();
