...
class UnifiedLoyaltyService {
  ...
  Future<TierInfoResponse> getTierInfo() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return TierInfoResponse(
          tiers: base.LoyaltyTier.values,
          currentTier: base.LoyaltyTier.bronze,
          tierBenefits: {},
          success: false,
  ...
  base.LoyaltyTier _parseTier(String? tierName) {
    if (tierName == null) return base.LoyaltyTier.bronze;
    switch (tierName.toLowerCase()) {
      case 'bronze':
        return base.LoyaltyTier.bronze;
      case 'silver':
        return base.LoyaltyTier.silver;
      case 'gold':
        return base.LoyaltyTier.gold;
      case 'platinum':
        return base.LoyaltyTier.platinum;
      default:
        return base.LoyaltyTier.bronze;
    }
  }
...
class TierInfoResponse {
  final List<base.LoyaltyTier> tiers;
  final base.LoyaltyTier currentTier;
