...
abstract class OrderRepository {
  ...
  Future<Result<Order, String>> updateOrderStatus(String orderId, OrderStatus status, {String? message});

  /// Rate an order
  Future<Result<void, String>> rateOrder(String orderId, double rating, {String? review});
}