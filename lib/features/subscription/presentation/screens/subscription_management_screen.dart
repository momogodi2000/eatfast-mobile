          ...
          children: [
            ...
            if (subscription?.isActive == true) ...[
              _buildActionTile(
                ...
                subtitle: 'Passer à un plan supérieur',
              ...
              _buildActionTile(
                ...
                subtitle: 'Résilier à la fin de la période',
        ...
        content: Column(
          ...
          children: [
            if (currentSubscription != null)
              Text('Vous allez passer de ${currentSubscription.plan.name} à ${plan.name}.'),
            const SizedBox(height: 16),
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Abonnement à ${plan.name} activé avec succès !'),
  ...
  void _showPauseDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Votre abonnement sera suspendu et vous n\'aurez plus accès aux avantages premium. '
