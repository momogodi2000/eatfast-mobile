...
class _PromotionsScreenState extends ConsumerState<PromotionsScreen> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Découvrez nos offres exclusives et économisez sur vos plats préférés',
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: DesignTokens.spaceSM),
                  Text(
                    'Connecter les Camerounais à leurs plats traditionnels préférés avec une livraison rapide et fiable. Nous valorisons la cuisine locale et soutenons les restaurants de notre communauté.',
                    style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                      color: DesignTokens.textSecondary,
                      height: 1.5,
                    ),
  ...
  Widget _buildPromotionCard(BuildContext context, int index) {
    final promotions = [
      {
        'title': 'Première commande -20%',
        'description': 'Économisez 20% sur votre première commande avec le code BIENVENUE20',
        'code': 'BIENVENUE20',
      ...
      },
      {
        ...
        'description': 'Livraison gratuite pour toute commande supérieure à 15,000 FCFA',
        'code': 'LIVRAISON0',
      ...
      },
      {
        ...
        'description': 'Réduction spéciale sur notre sélection quotidienne de plats traditionnels',
        'code': 'TRADITION15',
