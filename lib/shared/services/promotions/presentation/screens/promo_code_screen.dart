...
import 'package:eatfast_mobile/shared/services/promotions/providers/promo_code_provider.dart';
...
class _PromoCodeScreenState extends ConsumerState<PromoCodeScreen> {
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Text(
                                'Code appliqu�: ${promoState.appliedPromo!.promoCode.code}',
                              ...
                              Text(
                                '�conomie: ${promoState.appliedPromo!.discountAmount.toInt()} FCFA',
                                style: const TextStyle(
                                  fontSize: 14,
                                  color: Colors.green,
                                ),
            ...
            child: ListView(
              ...
              children: [
                ...
                if (validPromoCodes.isEmpty && promoState.availablePromoCodes.isNotEmpty) ...[
                  ...
                  Text(
                    'Ces codes ne peuvent pas �tre appliqu�s � cette commande',
                    style: TextStyle(
                  ...
                  Center(
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 8),
                        Text(
                          'Revenez bient�t pour d�couvrir nos offres!',
                          style: TextStyle(
              ...
              child: SizedBox(
                ...
                child: AppButton(
                  ...
                  text: promoState.appliedPromo != null
                      ? 'Confirmer (${promoState.appliedPromo!.discountAmount.toInt()} FCFA �conomis�s)'
  ...
  String _getUnavailableReason(PromoCode promo) {
    ...
    if (promo.isFirstTimeOnly && !widget.isFirstOrder) {
      return 'R�serv� aux nouveaux clients';
    }
    if (!promo.isValid) {
      return 'Code expir� ou non valide';
    }
    return 'Non applicable � cette commande';
  }
    ...
    if (success) {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Code promo appliqu� avec succ�s!'),
  ...
  Future<void> _applySpecificPromo(PromoCode promo) async {
    ...
    if (success) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text('Code ${promo.code} appliqu�!'),
            backgroundColor: Colors.green,
          ),
        );
      }
