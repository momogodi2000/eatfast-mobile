            ...
            children: [
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: const Text('Questions Fr�quentes (FAQ)'),
                ),
              ),
            ],
          ),
                  ...
                  ExpansionTile(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text('Vous pouvez passer votre commande directement via l\'application. Choisissez vos plats, ajoutez-les au panier et proc�dez au paiement.'),
                      ),
                    ],
                  ),
                  ExpansionTile(
                    title: Text('Quels sont les modes de paiement accept�s ?'),
                    children: [
                      Padding(
                        padding: EdgeInsets.all(16.0),
                        child: Text('Nous acceptons Mobile Money (MTN, Orange), EU Mobile et les paiements en esp�ces � la livraison.'),
                      ),
                    ],
                  ),
                  ExpansionTile(
                    title: Text('Quel est le d�lai de livraison ?'),
                    children: [
                      Padding(
                        padding: EdgeInsets.all(16.0),
                        child: Text('Le d�lai moyen de livraison est de 30 minutes, selon votre localisation et la disponibilit� des plats.'),
                      ),
                    ],
                  ),
                  ExpansionTile(
                    title: Text('Livrez-vous partout � Yaound� ?'),
                    children: [
                      Padding(
                        padding: EdgeInsets.all(16.0),
                        child: Text('Nous livrons dans la plupart des quartiers de Yaound�. V�rifiez la disponibilit� de la livraison lors de la commande.'),
                      ),
                    ],
                  ),
                ],
