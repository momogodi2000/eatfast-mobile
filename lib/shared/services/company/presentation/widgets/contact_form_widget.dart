              ...
              TextFormField(
                ...
                validator: (value) {
                  ...
                  if (value.trim().length > 5000) {
                    return 'Maximum 5000 caract?res';
                  }
                  return null;
                },
              ),
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Message envoy? avec succ?s! Nous vous r?pondrons dans les plus brefs d?lais.'),
