...
import 'package:eatfast_mobile/shared/services/restaurant/restaurant_service.dart' show MenuCategory;
  ...
  Widget _buildRestaurantInfo(Restaurant restaurant) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            (restaurant.description?.isNotEmpty ?? false) ? restaurant.description! : 'Aucune description disponible',
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoSection('Horaires', [
            (restaurant.openingHours?.isNotEmpty ?? false) ? restaurant.openingHours.toString() : 'Horaires non disponibles'
          ]),
          
          const SizedBox(height: DesignTokens.spaceXL),
          
          _buildInfoSection('Spécialités', (restaurant.specialties?.isNotEmpty ?? false) ? restaurant.specialties! : ['Information non disponible']),

          const SizedBox(height: DesignTokens.spaceXL),

          _buildInfoSection('Moyens de paiement', (restaurant.paymentMethods?.isNotEmpty ?? false) ? restaurant.paymentMethods! : ['Information non disponible']),
        ],
      ),
    );
  }
