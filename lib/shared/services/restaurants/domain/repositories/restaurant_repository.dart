...
abstract class RestaurantRepository {
  ...
  Future<Result<List<MenuItem>, String>> getMenuItems(
    String restaurantId, {
    String? categoryId,
  });

  /// Search restaurants by query
  Future<Result<List<Restaurant>, String>> searchRestaurants(
    String query, {
    RestaurantFilter? filter,
  });

  /// Search menu items by query
  Future<Result<List<MenuItem>, String>> searchMenuItems(
    String query, {
    String? restaurantId,
  });
