                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '�valuation ${widget.ratingType.displayName.toLowerCase()}',
                          style: TextStyle(
                            color: Colors.grey[600],
                            fontSize: 14,
                          ),
  ...
  String _getCommentHint() {
    switch (widget.ratingType) {
      case RatingType.restaurant:
        return 'Parlez-nous de votre exp�rience : qualit� des plats, service, propret�...';
      case RatingType.item:
        return 'Comment avez-vous trouv� ce plat ? Go�t, pr�sentation, portion...';
      case RatingType.delivery:
        return 'Comment s\'est pass�e la livraison ? Rapidit�, �tat des plats...';
    }
  }
