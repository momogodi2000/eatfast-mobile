...
class WalletService {
  ...
  Future<WalletResponse> getWallet() async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        return WalletResponse(wallet: wallet, success: true);
      } else {
      ...
      return WalletResponse(success: false, error: _handleDioError(e));
    } catch (e) {
      return WalletResponse(
        success: false,
  ...
  Future<TopUpResponse> topUpWallet(TopUpRequest request) async {
    try {
      ...
      return TopUpResponse(success: false, error: _handleDioError(e));
    } catch (e) {
      return TopUpResponse(
        success: false,
        error: 'An unexpected error occurred',
...
class WalletResponse {
  ...
  WalletResponse({this.wallet, required this.success, this.error});
}
...
class PaginationInfo {
  ...
  factory PaginationInfo.empty() {
    return PaginationInfo(total: 0, page: 1, limit: 20, totalPages: 0);
  }
}
