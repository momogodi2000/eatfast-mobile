...
import 'package:eatfast_mobile/shared/services/tips/providers/tip_provider.dart';
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 8),
                  Text(
                    'Le pourboire va directement � votre livreur',
                    style: TextStyle(
  ...
  Future<void> _submitTip() async {
    ...
    if (success && mounted) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Pourboire de ${calculation.formattedTip} envoy� � ${widget.driverName}!'),
