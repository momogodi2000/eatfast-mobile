...
class _EnhancedOrderTrackingScreenState extends ConsumerState<EnhancedOrderTrackingScreen>
  ...
  Widget _buildBody() {
    ...
    if (_orderTracking == null) {
      return const Center(
        child: Text('Aucune information de commande trouv�e'),
      );
    }
            ...
            if (order.estimatedDeliveryTime != null) ...[
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 8),
                  Text('Livraison estim�e: ${order.estimatedDeliveryTime}'),
                ],
              ),
            ],
          ],
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text(order.driverName ?? 'Livreur assign�'),
              subtitle: order.driverPhone != null
                  ? Text('T�l�phone: ${order.driverPhone}')
                  : null,
                ...
                child: const Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('(� impl�menter avec Google Maps)'),
                    ],
                  ),
                ),
              ),
  ...
  void _showCancelDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          '�tes-vous s�r de vouloir annuler cette commande ? '
  ...
  void _cancelOrder() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Annulation de commande � impl�menter')),
    );
  }
  ...
  void _showAccountCreationDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          'Cr�ez un compte EatFast pour suivre toutes vos commandes '
          'et b�n�ficier de nos avantages.',
        ),
        actions: [
          TextButton(
            onPressed: () => Navigator.of(context).pop(),
