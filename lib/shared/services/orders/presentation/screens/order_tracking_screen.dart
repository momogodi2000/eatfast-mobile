...
class _OrderTrackingScreenState extends ConsumerState<OrderTrackingScreen> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            'Arriv�e pr�vue dans 10 minutes',
        ...
        if (order.isDelivered) ...[
          SizedBox(
            ...
            child: ElevatedButton.icon(
              ...
              label: const Text('�valuer la commande'),
            ),
          ),
          const SizedBox(height: DesignTokens.spaceSM),
          SizedBox(
            ...
            child: OutlinedButton.icon(
              ...
              icon: const Icon(Icons.refresh),
              label: const Text('Commander � nouveau'),
            ),
          ),
        ],
  ...
  void _showCancelDialog(Order order) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          '�tes-vous s�r de vouloir annuler cette commande ? Cette action ne peut pas �tre annul�e.',
        ),
        actions: [
          TextButton(
    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setState) => AlertDialog(
          title: const Text('�valuer la commande'),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text('Qu\'avez-vous pens� de votre commande de ${order.restaurantName} ?'),
              const SizedBox(height: DesignTokens.spaceLG),
              Row(
                mainAxisAlignment: MainAxisAlignment.center,
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                // TODO: Submit rating
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Merci pour votre �valuation!')),
                );
              },
  ...
  void _reorderOrder(Order order) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Nouvelle commande cr��e!')),
    );
  }
  ...
  String _formatDateTime(DateTime dateTime) {
    return '${dateTime.day}/${dateTime.month}/${dateTime.year} � ${dateTime.hour}h${dateTime.minute.toString().padLeft(2, '0')}';
  }
}
