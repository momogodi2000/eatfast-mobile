...
import 'package:eatfast_mobile/shared/services/analytics/domain/models/analytics.dart';

class AnalyticsDashboardCard extends ConsumerWidget {
  final AnalyticsCard card;
  final VoidCallback? onTap;

  const AnalyticsDashboardCard({super.key, required this.card, this.onTap});
...
class AnalyticsKPICard extends ConsumerWidget {
  ...
  const AnalyticsKPICard({super.key, required this.kpi, this.onTap});
