...
class DesignTokens {
  ...
  static const double spacingXS = 8.0; // Alias for compatibility
  static const double spacingSM = 12.0; // Alias for compatibility
  static const double spacingMD = 16.0; // Alias for compatibility
  static const double spacingLG = 24.0; // Alias for compatibility
