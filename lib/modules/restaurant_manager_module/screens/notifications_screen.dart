...
class _NotificationsScreenState extends ConsumerState<NotificationsScreen> {
      ...
      child: SingleChildScrollView(
        ...
        child: Row(
          children: [
            ...
            const SizedBox(width: 8),
            _buildFilterChip('Syst�me', 'system', Icons.info),
          ],
        ),
      ),
    );
    ...
    switch (type) {
      case 'order':
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Ouvrir les d�tails de la commande'),
  ...
  void _showClearConfirmation() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text(
          '�tes-vous s�r de vouloir effacer toutes les notifications?\n\n'
  ...
  void _clearAllNotifications() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Toutes les notifications ont �t� effac�es'),
        backgroundColor: DesignTokens.successColor,
      ),
    );
  }
  ...
  List<Map<String, dynamic>> _getMockNotifications() {
    return [
      ...
      },
      {
        ...
        'type': 'review',
        'title': 'Nouvel Avis',
        'message': 'Client Jean a laiss� un avis 5 �toiles',
        'time': 'Il y a 15 min',
        'isUnread': true,
      },
      {
        ...
        'message': 'Commande #12344 a �t� livr�e avec succ�s',
        'time': 'Il y a 1 heure',
        'isUnread': false,
      },
      {
      ...
      },
      {
        ...
        'message': 'Commande #12343 a �t� annul�e par le client',
      ...
      },
      {
        ...
        'message': 'Marie a pos� une question sur votre menu',
      ...
      },
      {
        ...
        'type': 'system',
        'title': 'Rappel',
        'message': 'N\'oubliez pas de mettre � jour vos horaires d\'ouverture',
        'time': 'Hier',
        'isUnread': false,
      },
    ];
