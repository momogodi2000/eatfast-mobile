      ...
      return RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            Text(
              'Vos transactions appara�tront ici',
              textAlign: TextAlign.center,
  ...
  Widget _buildRevenueTab() {
    return SingleChildScrollView(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _buildSectionTitle('R�sum� des Revenus'),
          const SizedBox(height: DesignTokens.spaceMD),
          _buildRevenueCards(),
          const SizedBox(height: DesignTokens.spaceXL),

          _buildSectionTitle('Revenus par P�riode'),
          const SizedBox(height: DesignTokens.spaceMD),
          _buildPeriodRevenueCards(),
          const SizedBox(height: DesignTokens.spaceXL),

          _buildSectionTitle('D�tails des Commissions'),
          const SizedBox(height: DesignTokens.spaceMD),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Divider(),
                _buildInfoRow('D�lai de Traitement', '24-48 heures'),
              ],
            ),
          ),
        ),
  ...
  Widget _buildPeriodRevenueCards() {
    return Column(
      children: [
        ...
        const SizedBox(height: DesignTokens.spaceMD),
        _buildPeriodCard('Cette Ann�e', '8,450,000', Colors.orange),
      ],
    );
  }
          ...
          children: [
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Montant � retirer (FCFA)',
  ...
  Future<void> _processWithdrawal(String amount) async {
    ...
    result.when(
      success: (_) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Demande de retrait envoy�e. Traitement dans 24-48h'),
            backgroundColor: DesignTokens.successColor,
          ),
        );
