...
class _RestaurantProfileScreenState extends ConsumerState<RestaurantProfileScreen>
        ...
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'D�finissez la distance maximale pour les livraisons',
                    style: TextStyle(
                      fontSize: 14,
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: const Text('Enregistrer les Param�tres'),
            ),
          ),
        ],
      ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSectionTitle('M�thodes de Paiement'),
          const SizedBox(height: DesignTokens.spaceMD),
          Card(
            elevation: 2,
            shape: RoundedRectangleBorder(
        ...
        child: Column(
          ...
          children: [
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Pour les commandes sup�rieures � un montant'),
              value: false,
              onChanged: (value) {},
            ),
          ],
  ...
  void _saveProfileInformation() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Profil enregistr� avec succ�s'),
  ...
  void _saveDeliverySettings() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Param�tres de livraison enregistr�s'),
        backgroundColor: DesignTokens.successColor,
      ),
    );
  }
  ...
  void _toggleRestaurantStatus(bool isOpen) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(isOpen ? 'Restaurant ouvert' : 'Restaurant ferm�'),
