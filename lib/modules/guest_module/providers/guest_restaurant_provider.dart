...
import '../services/data/services/guest_restaurant_service.dart';
...
class GuestRestaurantNotifier extends StateNotifier<GuestRestaurantState> {
  ...
  String getDistanceText(Restaurant restaurant) {
    if (state.currentLocation == null ||
        ...
        restaurant.address!.coordinates.latitude == 0.0) {
      return '';
    }
    ...
    final distance = _service.calculateDistance(
      ...
      endLatitude: restaurant.address!.coordinates.latitude,
      endLongitude: restaurant.address!.coordinates.longitude,
    );
...
final guestRestaurantProvider =
    StateNotifierProvider<GuestRestaurantNotifier, GuestRestaurantState>((ref) {
...
final guestRestaurantDetailsProvider =
...
final guestRestaurantMenuProvider =
