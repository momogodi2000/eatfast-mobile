...
import '../services/data/services/guest_session_service.dart';
...
class GuestSessionNotifier extends StateNotifier<GuestSessionState> {
  ...
  Future<void> clearSession() async {
    try {
      ...
      state = state.copyWith(error: 'Failed to clear session: \$e');
    }
  }
...
final guestSessionProvider =
    StateNotifierProvider<GuestSessionNotifier, GuestSessionState>((ref) {
