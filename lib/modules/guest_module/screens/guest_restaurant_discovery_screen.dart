...
import 'package:eatfast_mobile/modules/guest_module/providers/guest_restaurant_provider.dart';
import '../widgets/widgets/guest_restaurant_card.dart';
...
class GuestRestaurantDiscoveryScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<GuestRestaurantDiscoveryScreen> createState() =>
      _GuestRestaurantDiscoveryScreenState();
}

class _GuestRestaurantDiscoveryScreenState
    extends ConsumerState<GuestRestaurantDiscoveryScreen> {
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ref
                  .read(guestRestaurantProvider.notifier)
  ...
  Widget _buildRestaurantList(GuestRestaurantState state) {
    if (state.isLoading && state.restaurants.isEmpty) {
      return const Center(
        child: AppLoadingIndicator(message: 'Recherche des restaurants...'),
      );
    }
