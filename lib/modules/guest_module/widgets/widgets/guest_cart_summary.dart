...
class GuestCartSummary extends StatelessWidget {
  ...
  const GuestCartSummary({super.key, required this.cart});
      ...
      child: Column(
        ...
        children: [
          ...
          if (cart.items.isNotEmpty) ...[
            ...
            if (cart.tax > 0) _buildPriceRow(context, 'Taxes', cart.tax),

            const Divider(height: DesignTokens.spaceMD),

            _buildPriceRow(context, 'Total', cart.total, isTotal: true),
          ],
        ],
      ),
    );
