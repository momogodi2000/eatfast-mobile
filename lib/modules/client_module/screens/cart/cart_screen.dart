...
import 'package:eatfast_mobile/shared/services/cart/presentation/widgets/cart_conflict_dialog.dart';
...
class CartScreen extends ConsumerWidget {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (cart.discount > 0)
            _buildSummaryRow('Remise', '-${cart.discount.toInt()} FCFA', isDiscount: true),
          const Divider(),
          _buildSummaryRow(
            'Total',
      ...
      child: Row(
        ...
        children: [
          Text(
            label,
            style: TextStyle(
              fontSize: isTotal ? DesignTokens.fontSizeLG : DesignTokens.fontSizeMD,
  ...
  void _updateQuantity(BuildContext context, String itemId, int quantity, WidgetRef ref) {
  ...
  void _updateInstructions(BuildContext context, String itemId, String? instructions, WidgetRef ref) {
    ref.read(cartProvider.notifier).updateItemInstructions(itemId, instructions);
  }
  ...
  void _showClearCartDialog(BuildContext context, WidgetRef ref) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('�tes-vous s�r de vouloir supprimer tous les articles du panier ?'),
        actions: [
          TextButton(
