...
class _RealtimeOrderTrackingScreenState extends ConsumerState<RealtimeOrderTrackingScreen>
  ...
  Future<void> _loadInitialData() async {
    try {
      ...
      // Note: deliveryAddress is a String?, not an object with lat/long
      // TODO: Fix this to use proper restaurant location from order
      ...
      setState(() {
        ...
        if (_currentOrder != null) {
          _currentOrder = _currentOrder!.copyWith(
            ...
            estimatedDeliveryTime: update.estimatedDeliveryTime != null
  ...
  shared_models.OrderStatus _mapOrderStatus(String status) {
    switch (status.toLowerCase()) {
      case 'pending': return shared_models.OrderStatus.created;
      case 'confirmed': return shared_models.OrderStatus.confirmed;
      case 'preparing': return shared_models.OrderStatus.preparing;
      case 'ready': return shared_models.OrderStatus.readyForPickup;
      case 'picked_up': return shared_models.OrderStatus.pickedUp;
      case 'in_transit': return shared_models.OrderStatus.inTransit;
      case 'delivered': return shared_models.OrderStatus.delivered;
      case 'cancelled': return shared_models.OrderStatus.cancelled;
      default: return shared_models.OrderStatus.created;
    }
  }
