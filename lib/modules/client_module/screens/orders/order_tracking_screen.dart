...
import 'package:eatfast_mobile/shared/services/orders/presentation/widgets/order_items_summary.dart';
import 'package:eatfast_mobile/shared/services/orders/presentation/widgets/delivery_address_card.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Delivery address - skip if null
            if (order.deliveryAddress != null)
              DeliveryAddressCard(address: shared_models.UserAddress(
                id: '',
                userId: order.customerId ?? '',
                label: 'Livraison',
                streetAddress: order.deliveryAddress ?? '',
                city: order.restaurantName, // Using restaurantName as fallback
                country: 'Cameroon',
                isDefault: false,
