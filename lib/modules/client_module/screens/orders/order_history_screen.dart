...
import 'package:eatfast_mobile/shared/services/orders/presentation/widgets/order_card.dart';
...
class _OrderHistoryScreenState extends ConsumerState<OrderHistoryScreen>
  ...
  Widget _buildOrdersList(OrdersState ordersState, List<OrderStatus>? statusFilter) {
    return switch (ordersState) {
      OrdersInitial() => const Center(child: Text('Chargement des commandes...')),
      OrdersLoading() => const Center(child: AppLoadingIndicator()),
