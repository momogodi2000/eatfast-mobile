...
import '../../widgets/widgets/wallet/amount_selector.dart';
import '../../widgets/widgets/wallet/payment_method_selector.dart';
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    walletState.when(
                      data: (wallet) => Text(
                        '${wallet?.balance.toStringAsFixed(0) ?? '0'} ${wallet?.currency ?? 'XAF'}',
