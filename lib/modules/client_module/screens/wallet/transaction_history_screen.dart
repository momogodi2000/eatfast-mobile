          ...
          return RefreshIndicator(
            ...
            child: Column(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _SummaryItem(
                        title: 'Transactions',
                        value: wallet.recentTransactions.length.toString(),
                ...
                // Transactions List
                Expanded(
                  child: wallet.recentTransactions.isEmpty
                      ? Center(
                          child: Column(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                      ...
                      : ListView.builder(
                          ...
                          itemCount: wallet.recentTransactions.length + (_isLoadingMore ? 1 : 0),
                          itemBuilder: (context, index) {
                            if (index == wallet.recentTransactions.length) {
                            ...
                            return TransactionTile(
                              transaction: wallet.recentTransactions[index],
                            );
                          },
                        ),
                ),
